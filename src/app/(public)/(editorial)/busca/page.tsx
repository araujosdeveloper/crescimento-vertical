...
export const metadata: Metadata = { title: "Busca | Crescimento Vertical", robots: { index: false, follow: true }, alternates: { canonical: "https://crescimentovertical.com/busca" } };

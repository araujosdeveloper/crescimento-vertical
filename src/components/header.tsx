  ...
  return (
    <header className="site-header">
      <div className="header-shell">
        ...
        <ContactLink className="header-cta button-primary hidden md:inline-flex">
          {PRIMARY_CONTACT_LABEL} <ArrowUpRight size={16} />
        </ContactLink>
      ...
      {open && (
        <div className="mobile-menu md:hidden">
          <nav className="container-shell flex flex-col gap-1" aria-label="Navegação mobile">
            ...
            <ContactLink className="button-primary mt-3 justify-center" onClick={() => setOpen(false)}>
              {PRIMARY_CONTACT_LABEL} <ArrowUpRight size={16} />
            </ContactLink>
          </nav>
        </div>

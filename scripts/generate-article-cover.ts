...
async function main() {
  ...
  <circle cx="950" cy="620" r="160" fill="#f97316" opacity="0.08"/>
${titleSvg}
  <text x="120" y="685" font-family="DejaVu Sans, sans-serif" font-size="26" fill="#a3a3a3">Crescimento Vertical — IA · Automação · Negócios</text>
</svg>`;
